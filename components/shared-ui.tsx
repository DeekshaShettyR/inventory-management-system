...
export function Toaster() {
  ...
  return (
    <div className="fixed bottom-0 right-0 z-50 flex w-full max-w-105 flex-col gap-2 p-4 sm:bottom-0 sm:right-0 sm:top-auto">
      {toasts.map(function ({ id, title, description, action, open, onOpenChange, ...props }) {
        return (
          <Dialog key={id} open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-106.25" {...props}>
